...
class PaymentServiceUnitTest {
    ...
    void getPayments_ShouldFilterByAllParameters() {
        ...
        verify(paymentRepository, times(1))
                .findByUserIdAndOrderIdAndStatus(501L, 1001L, "SUCCESS");
    }
    ...
    void getTotalForUser_ShouldCalculateCorrectTotal() {
        ...
        when(paymentRepository.findByUserIdAndTimestampBetween(eq(501L), any(Instant.class), any(Instant.class)))
                .thenReturn(payments);
